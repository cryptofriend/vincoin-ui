...
WALLET_ROOT=$$PWD/vincoin

CONFIG += c++11

# cleaning "auto-generated" bitvincoin directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently vincoin has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/vincoin-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/vincoin-core_ar.ts \ # Arabic
                $$PWD/translations/vincoin-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/vincoin-core_de.ts \ # German
                $$PWD/translations/vincoin-core_eo.ts \ # Esperanto
                $$PWD/translations/vincoin-core_es.ts \ # Spanish
                $$PWD/translations/vincoin-core_fi.ts \ # Finnish
                $$PWD/translations/vincoin-core_fr.ts \ # French
                $$PWD/translations/vincoin-core_hr.ts \ # Croatian
                $$PWD/translations/vincoin-core_id.ts \ # Indonesian
                $$PWD/translations/vincoin-core_hi.ts \ # Hindi
                $$PWD/translations/vincoin-core_it.ts \ # Italian
                $$PWD/translations/vincoin-core_ja.ts \ # Japanese
                $$PWD/translations/vincoin-core_nl.ts \ # Dutch
                ...
                $$PWD/translations/vincoin-core_ko.ts \ # Korean
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libvincoin-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    vincoin/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = vincoin-core.rc
